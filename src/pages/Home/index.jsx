...
function Home() {
  ...
  const categories = [
    ...
    { id: 2, name: "Shokolad", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbp7PoArCqz3GLZpGxAEYVcKaGcJDlACvJnQ&s" },
    { id: 3, name: "Shokolad", image: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQbp7PoArCqz3GLZpGxAEYVcKaGcJDlACvJnQ&s" },
          ...
          <Swiper
            ...
            {categories.map((category, index) => (
              <SwiperSlide key={index} className='pb-10'>
                <div
                  className="w-auto lg:w-[195px] h-auto lg:h-[210px] p-2 lg:p-3 rounded-lg lg:rounded-xl border-[#f1f1f1] shadow-[0px_2px_14px_#00000017]"
                >
                  <div className="w-full h-2/3 overflow-hidden ">
                    <img
                      className="w-full h-full object-cover rounded-[6px] lg:rounded-[8px]"
                      alt={category.name}
                      src={category.image}
                    />
                  </div>
                  <p className=" text-black text-sm lg:text-base text-center mt-2">
                    {category.name}
                  </p>
                </div>
              </SwiperSlide>
