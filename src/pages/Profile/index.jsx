        ...
        <div className="flex gap-6 mt-10">
          ...
          <div className="w-2/3">
            ...
            {activeTab === "personal" && (
              ...
              <div>
                <h1 className='font-semibold text-2xl leading-[26px]'>Shaxsiy ma’lumotlar</h1>
                <div className='flex flex-col gap-4 w-1/2'>
                  <div>
                    <h5>Foydalanuvchi ID</h5>
                    <div className='px-4 py-2.5 mt-2 rounded-[10px] bg-[#EEEEEE]'>
                      <input className='w-full h-full outline-none' type="text" placeholder='123456789' />
                    </div>
                  </div>
                  <div>
                    <h5>Ism familiya</h5>
                    <div className='px-4 py-2.5 mt-2 rounded-[10px] bg-[#EEEEEE]'>
                      <input className='w-full h-full outline-none' type="text" placeholder='Farrux Bozorboyev' />
                    </div>
                  </div>
                  <div>
                    <h5>Telefon raqam</h5>
                    <div className='px-4 py-2.5 mt-2 rounded-[10px] bg-[#EEEEEE]'>
                      <input className='w-full h-full outline-none' type="text" placeholder='+998 (33) 513-60-53' />
                    </div>
                  </div>
                  <div>
                    <h5>Tug’ilgan kun</h5>
                    <div className='px-4 py-2.5 mt-2 rounded-[10px] bg-[#EEEEEE]'>
                      <input className='w-full h-full outline-none' type="text" placeholder='24/04/2001-yil' />
                    </div>
                  </div>
                  <div>
                    <h5>Elektron pochta</h5>
                    <div className='px-4 py-2.5 mt-2 rounded-[10px] bg-[#EEEEEE]'>
                      <input className='w-full h-full outline-none' type="text" placeholder='Mavjud emas' />
                    </div>
                  </div>
            ...
            {activeTab === "orders" && (
              <div>
                <h1 className='font-semibold text-2xl leading-[26px]'>Mening buyurtmalarim</h1>
                <div className="w-full bg-[#e5e6ff] rounded-[10px] p-5 space-y-4 mt-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="ml-[15px]">
                      <div className="text-base text-[#0a142fcc]">Yetkazib berishda</div>
                      <div className="text-base text-[#0a142fe6]">Buxoro</div>
                    </div>
                  </div>

                  <div className="flex items-center mt-[5px] cursor-pointer">
                    <span className="text-app-primary text-base">Batafsil ma’lumotni ko‘rsatish</span>
            ...
            {activeTab === "addresses" && (
              <div>
                <div className='w-full flex items-center justify-between'>
                  <h1 className='font-semibold text-app-primary text-2xl leading-[26px] whitespace-nowrap'>Manzillar</h1>
            ...
            {activeTab === "favorites" && (
              <div className="bg-[#f4f4f4] p-5 rounded-lg">Sevimli mahsulotlaringiz shu yerda chiqadi</div>
            )}
          </div>
        </div>
      </div>
